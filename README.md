...
| Screen | Preview |
| --- | --- |
| Screen 1 | ![Dashboard overview with library KPIs and quick actions](images/ss1.PNG) |
| Screen 2 | ![Book catalog list with search, filters, and availability](images/ss2.PNG) |
| Screen 3 | ![Member management table with roles and contact details](images/ss3.PNG) |
| Screen 4 | ![Issue book workflow with due date and fine preview](images/ss4.PNG) |
| Screen 5 | ![Return book screen showing outstanding loans](images/ss5.PNG) |
| Screen 6 | ![Sync queue status with conflict and failure visibility](images/ss6.PNG) |
| Screen 7 | ![Analytics charts for monthly issues and top books](images/ss7.PNG) |
| Screen 8 | ![Reports export view for PDF and Excel outputs](images/ss8.PNG) |
| Screen 9 | ![Settings panel for server URL and sync options](images/ss9.PNG) |
| Screen 10 | ![Login screen with role-based access](images/ss10.PNG) |
| Screen 11 | ![AI daily summary panel generated by local model](images/ss11.PNG) |
